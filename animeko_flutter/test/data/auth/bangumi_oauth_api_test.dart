...
void main() {
  ...
  group('oauth', () {
    test(
      'GETs /v2/users/bangumi/oauth with requestId/os/arch and parses url',
      () async {
        when(
  ...
  group('bind', () {
    test(
      'GETs /v2/users/bangumi/bind with requestId/os/arch and parses url',
      () async {
        when(
          () => dio.get<Map<String, dynamic>>(
